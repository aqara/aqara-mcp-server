...
> [!TIP]
> **推荐：Aqara 官方 Agent Skill**
>
> 如果您使用的 AI 宿主支持 Agent Skills（如 Claude、Cursor、OpenClaw 等），我们 **强烈推荐** 直接使用官方 **Aqara Agent Skills**：无需自行部署 MCP Server，即可通过自然语言完成家庭 / 空间、设备、场景、自动化、能耗等查询与控制，开箱即用。
>
